export default {
  ...
  todayData: {
    taskDetails: 'Today Task Details',
    ...
    needManual: 'Need Manual',
    appointmentConfirmed: 'Appointment Confirmed',
    appointmentNotConfirmed: 'Appointment Not Confirmed',
    people: ' people',
    manualProcessList: 'Manual Process Customer List',
    searchPatient: 'Search patient name',
    name: 'Name',
    gender: 'Gender',
    treatmentProject: 'Treatment',
    agreeWechat: 'Agree WeChat',
    viewRecord: 'View Record',
    customerType: 'Customer Type',
    manualProcess: 'Manual Process',
    processed: 'Processed',
    notProcessed: 'Not Processed',
    notConnectedProcess: 'Not Connected Customer Process',
