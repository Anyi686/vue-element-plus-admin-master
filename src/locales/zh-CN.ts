export default {
  ...
  todayData: {
    ...
    riskWarning: '风险预警',
    needManual: '需人工处理',
    appointmentConfirmed: '预约提醒确认',
    appointmentNotConfirmed: '预约提醒未确认',
    people: '人',
    manualProcessList: '待人工处理客户清单',
    searchPatient: '患者名称搜索',
    name: '姓名',
    gender: '性别',
